...
- Waiting on the owner: `06-account-setup/wave-1-signup-pack.md` (~75 min) + `06-account-setup/round-2-additions.md` (permissions, Payment Links, ad accounts, domain, Fiverr).
